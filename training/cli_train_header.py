...
def parse_args():
    ...
    parser.add_argument(
        ...
        default="csn",
        choices=["csn", "vmae"],
        help="Backbone model: csn or vmae",
    )
    parser.add_argument(
        "--finetune_mode",
        default="full",
    ...
    parser.add_argument(
        "--output_root",
        default="report/header_experiments",
...
def main():
    ...
    with open(metrics_path, "w") as f:
        f.write(
            "epoch,train_loss,val_loss,val_acc,val_precision,val_recall,val_f1,val_auc,lr_backbone,lr_head\n"
        )
